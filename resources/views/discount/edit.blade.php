...
<body>
    ...
    <?php
    echo Form::model($discount, array('route' => array('discount.update', $discount->id), 'enctype'=>'multipart/form-data'));
    ?>
    @method('PUT')
    <?php
    echo '<div class="mb-3">';
        echo Form::label('percent', 'Percent', array('class'=>'form-label'));
        echo Form::text('percent', null, array('id' => 'percentInput','class' => 'form-control'));
    echo '</div>';
